        ...
        <div className="py-12 md:py-16">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:gap-12">
            ...
            <div className="col-span-2 md:col-span-1">
              <Link
                href="/"
                className="flex items-center gap-2 font-heading text-base font-semibold text-[var(--color-text-primary)]"
              >
                <span className="flex h-6 w-6 items-center justify-center rounded bg-[var(--color-accent)] text-xs font-bold text-white">
